...
from lichess_types import GameEventType
from collections.abc import Sequence
from timer_ import seconds
...
class Conversation:
    ...
    def react(self, line: ChatLine) -> None:
        ...
        send_text(f"*** {self.game.url()} [{line.room}] {line.username}: {line.text}")
    ...
    def send_reply(self, line: ChatLine, reply: str) -> None:
        ...
        send_text(f"*** {self.game.url()} [{line.room}] {self.game.username}: {reply}")
